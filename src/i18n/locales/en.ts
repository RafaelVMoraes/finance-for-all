...
export const en: TranslationTree = {
  ...
  investments: {
    ...
    form: {
      label: 'Label',
      labelPlaceholder: 'e.g., S&P 500 ETF',
      type: 'Type',
    ...
    exchangeRates: {
      title: 'Exchange Rates - {{month}}',
      oneUnit: '1 {{currency}} =',
      fallback: 'Fallback',
    },
    alerts: {
      missingRates: 'Exchange rates not defined for {{month}}.',
      usingFallback: 'Using previous rates as fallback.',
      unconfirmedCount: '{{count}} asset(s) need value confirmation for {{month}}.',
      updateCurrentMonth: 'Please update value for current month',
      unconfirmedPrefix: '{{count}} assets',
    },
    feedback: {
  ...
  dashboard: {
    ...
    investmentsGrowthByType: 'Investment Growth % by Type',
    forecastInYears: '{{years}}y forecast',
    lastThreeMonthsInvestmentRates: 'Last 3 months investment evolution %',
    noInvestmentDataYet: 'No investment data yet',
  },
};
